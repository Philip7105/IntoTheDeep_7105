...
public class BlueClipSide4 extends BaseAuto {
    ...
    public void runAuto() {
        ...
        runpath = new MultipleRRActionsWithPathing(new Action[]{groups.moveVerticalSlidesAction(lowchamber,autoTolerance),robot.driveTrain.strafeToLinearHeading(new Vector2d(-14, 63), Math.toRadians(90), new Vector2d(-1.5,32),Math.toRadians(90))})
               ...
               //  clip first specimen
                .addNext(new MultipleRRActionsWithPathing(new Action[]{robot.driveTrain.strafeToLinearHeading(new Vector2d(-1.5,32),Math.toRadians(90), new Vector2d(-37,37), Math.toRadians(90)), groups.moveVerticalSlidesAction(0, autoTolerance),
