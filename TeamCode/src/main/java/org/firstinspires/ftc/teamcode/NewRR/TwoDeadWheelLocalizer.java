...
import org.firstinspires.ftc.teamcode.NewRR.messages.TwoDeadWheelInputsMessage;

@Config
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3.9459112920817887; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.010596826063493317; // x position of the perpendicular encoder (in tick units)
    }
