...
public class BlueClipSide4Different extends BaseAuto {
    ...
    public void runAuto() {
        ...
        runpath = new MultipleRRActionsWithPathing(new Action[]{groups.moveVerticalSlidesAction(lowchamber,autoTolerance),robot.driveTrain.strafeToLinearHeading(new Vector2d(-15,63), Math.toRadians(90),new Vector2d(1,32),Math.toRadians(90))})
                .addNext(new MultipleRRActionsWithPathing(new Action[]{groups.moveVerticalSlidesAction(lowbasket,autoGreaterTolerance),groups.delayAction(.6, groups.moveGripperAction(JohnsIntake.GripperStates.unclamp)),
                ...
                .addNext(new MultipleRRActionsWithPathing(new Action[]{robot.driveTrain.strafeToLinearHeading(new Vector2d(-47,48.6), Math.toRadians(90),new Vector2d(-2.5,33), Math.toRadians(90)),
                        ...
                        groups.delayAction(1.1,groups.moveVerticalSlidesAction(lowchamber,autoTolerance)),
                ...
                , groups.moveVerticalSlidesAction(0,autoTolerance),
