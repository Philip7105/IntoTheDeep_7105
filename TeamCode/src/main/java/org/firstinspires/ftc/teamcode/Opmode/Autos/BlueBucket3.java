...
public class BlueBucket3 extends BaseAuto {
    ...
    public void runAuto() {
        ...
        runpath = new MultipleRRActionsWithPathing(new Action[]{robot.driveTrain.strafeToLinearHeading(new Vector2d(32,60), Math.toRadians(270),new Vector2d(52.3, 56), Math.toRadians(225)), groups.moveVerticalSlidesAction(lowbasket,autoTolerance)})
                .addNext(new MultipleRRActionsWithPathing(new Action[]{groups.moveVerticalSlidesAction( highbasket,autoTolerance), robot.driveTrain.strafeToLinearHeading(new Vector2d(52.3,56),Math.toRadians(225),new Vector2d(57,55),Math.toRadians(225))}))
                .addNext(new Delay(.5))
