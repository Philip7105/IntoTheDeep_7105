...
public class JohnsIntake extends Subsystem {
    ...
    public static double clamp = .74, unclamp = 0.245,basketpos = .64,preclip = 0.215, hookclip = .31,chamberpos = .76, down = 0.14, parallel = .26,lowerpickup = .13,intakeSlow = .8,intakeSpeed = 1,outtake = -.6;//.78  .155
